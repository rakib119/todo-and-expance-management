                        ...
                        <div class="col-sm-6">
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Edit Expance</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="container form py-3 ">
                                        <form action="{{ route('expense.update', $expense_details->id) }}" method="post"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select select" name="exp_cat_id"
                                                            ...
                                                            @foreach ($categories as $category)
                                                                <option
                                                                    <?= $expense_details->exp_cat_id == $category->id ? 'selected' : '' ?>
                                                                    value="{{ $category->id }}">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ $expense_details->purpose }}" name="purpose">
                                                        @error('purpose')
                                                            <small class="text-danger"> {{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="spend_amount" id="spend_amount"
                                                            value="{{ $expense_details->spend_amount }}"
                                                            class="form-control">
                                                        @error('spend_amount')
                                                            <small class="text-danger"> {{ $message }}</small>
                                                        @enderror
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="file" name="receipt" accept=".jpg,.png,.JPG,.PNG"
                                                            id="receipt" value="" class="form-control">
                                                        @error('receipt')
                                                            <small class="text-danger"> {{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="datetime-local" name="created_at" id="created_at"
                                                            value="{{ $expense_details->created_at }}"
                                                            class="form-control">
                                                        @error('created_at')
                                                            <small class="text-danger"> {{ $message }}</small>
                                                        @enderror
